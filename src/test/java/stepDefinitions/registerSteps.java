...
public class registerSteps {
	...
	//getting the testdata from excel and passing it to the user validation methods
		List<Map<String, String>> testdata = reader.getData("C:\\Users\\shiva\\eclipse-workspace\\DS_Algo_CucumberBDD\\src\\test\\resources\\Exceldata\\uservalidation.xlsx", sheetName);
